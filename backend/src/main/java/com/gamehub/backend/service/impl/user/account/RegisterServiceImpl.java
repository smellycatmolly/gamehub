...
import com.gamehub.backend.service.user.account.RegisterService;
...
public class RegisterServiceImpl implements RegisterService {
    @Autowired
    private UserMapper userMapper;  // 导入数据库
    ...
    public Map<String, String> register(String username, String password, String confirmedPassword) {
        ...
        username = username.trim();  // 去除字符串首尾的空白字符（空格、制表符、换行符等）
        ...
        User user = new User(null, username, encodedPassword, photo);  // id是自增的不用传入
