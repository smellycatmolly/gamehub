...
public class WebSocketServer {
    ...
    final private static ConcurrentHashMap<Integer, WebSocketServer> users = new ConcurrentHashMap<>();  // 存储所有连接的 WebSocketServer 实例  // 线程安全的哈希表：把用户ID映射到线程  // 加static静态变量：对于所有实例来说访问的都是同一个哈希表
